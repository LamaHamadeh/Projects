...
A1 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 1\1.tif'); %471   471     3
A1 = imresize(double(A1(:,:,1)),[60 60]); %choose only the red channel from 0 to 256
A2 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 1\2.tif'); %467   467     3
A2 = imresize(double(A2(:,:,1)),[60 60]);
A3 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 1\3.tif'); %477   477     3
A3 = imresize(double(A3(:,:,1)),[60 60]);
A4 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 1\4.tif'); %519   459     3
A4 = imresize(double(A4(:,:,1)),[60 60]);
%Read images from Time 2
B1 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 2\1.tif'); %471   471     3
B1 = imresize(double(B1(:,:,1)),[60 60]);
B2 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 2\2.tif'); %467   467     3
B2 = imresize(double(B2(:,:,1)),[60 60]);
B3 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 2\3.tif'); %477   477     3
B3 = imresize(double(B3(:,:,1)),[60 60]);
B4 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 2\4.tif'); %519   459     3
B4 = imresize(double(B4(:,:,1)),[60 60]);
%Read images from Time 3
C1 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 3\1.tif'); %471   471     3
C1 = imresize(double(C1(:,:,1)),[60 60]);
C2 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 3\2.tif'); %467   467     3
C2 = imresize(double(C2(:,:,1)),[60 60]);
C3 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 3\3.tif'); %477   477     3
C3 = imresize(double(C3(:,:,1)),[60 60]);
C4 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 3\4.tif'); %519   459     3
C4 = imresize(double(C4(:,:,1)),[60 60]);
%Read images from Time 4
D1 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 4\1.tif'); %471   471     3
D1 = imresize(double(D1(:,:,1)),[60 60]);
D2 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 4\2.tif'); %467   467     3
D2 = imresize(double(D2(:,:,1)),[60 60]);
D3 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 4\3.tif'); %477   477     3
D3 = imresize(double(D3(:,:,1)),[60 60]);
D4 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Training\Time 4\4.tif'); %519   459     3
...
%Read images
T1 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Test\Time 1\5.tif');
T1 = imresize(double(T1(:,:,1)),[60 60]);
T2 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Test\Time 2\5.tif');
T2 = imresize(double(T2(:,:,1)),[60 60]);
T3 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Test\Time 3\5.tif');
T3 = imresize(double(T3(:,:,1)),[60 60]);
T4 = imread('C:\Users\PHY3HAMADL\Desktop\Blood_Research\2019\Blood_Droplets_Kirsten\EigenDroplet\Test\Time 4\5.tif');
