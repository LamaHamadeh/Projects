...
%Final note:
% One might be able to argue that the Gaussian filter produces slightly
% better image result since the inverse Fourier transform of a step/square
% function produces sinc-like behaviour. However, the Foruier transform of
% a Gaussian is still a Gaussian.